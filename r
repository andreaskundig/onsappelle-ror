                                  Prefix Verb   URI Pattern                                                                                       Controller#Action
                                                /ruby_lsp_rails                                                                                   #<RubyLsp::Rails::RackApp:0x00007f491fb05ee0>
                                    root GET    /                                                                                                 reminders#new
                         new_user_inputs GET    /new_user_inputs(.:format)                                                                        reminders#new_user_inputs
                    remove_reminder_user DELETE /reminders/:reminder_id/users/:id/remove(.:format)                                                reminders#remove_user
